      ...
      <div className="mx-auto w-full max-w-[1700px] px-6 sm:px-10">
        ...
        >
          ...
          <div className="flex flex-none flex-wrap items-center justify-center gap-3">
            ...
            <Link
              href="#"
              className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-chalk/25 px-6 py-3 font-mono text-xs font-bold uppercase tracking-[0.1em] text-chalk transition-colors hover:border-accent-strong hover:text-accent-strong"
            >
          ...
          <div className="relative hidden h-28 w-20 flex-none -rotate-6 overflow-hidden rounded-lg border border-accent-strong/40 bg-black shadow-2xl lg:block">
