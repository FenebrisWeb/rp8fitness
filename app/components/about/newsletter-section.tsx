    ...
    <section className="border-t border-white/10 bg-black">
      <div className="mx-auto flex w-full max-w-[1700px] flex-col items-center gap-8 px-6 py-10 text-center sm:flex-row sm:justify-between sm:px-10 sm:text-left">
        <div className="flex flex-none items-start gap-3 sm:max-w-xs">
          <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full border border-lime/50 text-lime">
        ...
        <form className="flex w-full max-w-md flex-none items-center gap-2 sm:w-auto">
          <input
            ...
            className="w-full min-w-0 rounded-full border border-chalk/20 bg-transparent px-4 py-2.5 font-mono text-xs text-chalk placeholder:text-steel focus:border-lime focus:outline-none sm:w-56"
          />
          <button
            type="submit"
            className="flex-none cursor-pointer rounded-full bg-lime px-5 py-2.5 font-mono text-[11px] font-bold uppercase tracking-[0.1em] text-ink transition-transform hover:scale-105"
          >
            {ctaLabel}
          </button>
        </form>
          ...
          <div className="flex items-center gap-2">
            {SOCIAL_LINKS.map((social) => (
              <Link
                ...
                className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-chalk/25 text-chalk transition-colors hover:border-lime hover:text-lime"
              >
