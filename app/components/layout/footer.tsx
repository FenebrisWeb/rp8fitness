  ...
  return (
    <footer className="border-t border-white/10">
      <div className="mx-auto w-full max-w-[1700px] px-6 py-14 sm:px-10 sm:py-16">
        <div className="grid grid-cols-2 gap-x-8 gap-y-12 sm:grid-cols-3 lg:grid-cols-5 lg:gap-x-10">
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <p className="mt-4 max-w-[220px] font-mono text-sm text-steel">{tagline}</p>
            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <Link
                  ...
                  className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-foreground/25 text-foreground transition-colors hover:border-lime hover:text-lime"
                >
              ...
              <ul className="mt-4 flex flex-col gap-3">
                {group.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="font-mono text-sm text-steel transition-colors hover:text-lime"
                    >
                      {link.label}
                    </Link>
                  </li>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-[1700px] flex-wrap items-center justify-between gap-2 px-6 py-6 font-mono text-[11px] uppercase tracking-[0.14em] text-steel sm:px-10">
